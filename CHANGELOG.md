...
- Remove push trigger for main to eliminate duplicate runs  (1115d6a)
## [0.2.26] - 2026-03-28

### Documentation

- Migrate examples to Helm, add ReaperDaemonJob quick-start docs  (6f2c7bb)
## [0.2.25] - 2026-03-28

### Miscellaneous

- Migrate CRD API group from reaper.io to reaper.giar.dev   (3fc3be9)
## [0.2.24] - 2026-03-28

### Performance

- Optimize CI integration test runtime   (fd49784)
## [0.2.23] - 2026-03-27

### Miscellaneous

- Make Linux the default clippy target for development  (3cdb047)
## [0.2.22] - 2026-03-27

### Documentation

- Add local documentation build/serve instructions to DEVELOPMENT.md  (084509b)
## [0.2.21] - 2026-03-22

### Documentation

- ReaperDaemonJob docs, fix truncated node-config, update examples  (f6299f3)
## [0.2.20] - 2026-03-22
...
- Implement dynamic PTY resize (ResizePty)  (0353a09)
## [0.2.18] - 2026-03-21

### Features

- ReaperOverlay CRD for overlay lifecycle management  (b890734)
## [0.2.17] - 2026-03-19

### Bug Fixes

- Use sanitized writable copies for shadow file filtering   (59ee7c2)
## [0.2.16] - 2026-03-19

### Bug Fixes

- Improve docs workflow with Pages setup guidance   (c511710)
## [0.2.15] - 2026-03-19

### Documentation

- Consolidate documentation, add examples, and mdBook site  (9fde935)
## [0.2.14] - 2026-03-16

### Bug Fixes

- Update GitHub Actions to Node.js 24-compatible versions  (f5291d6)
## [0.2.13] - 2026-03-16
...
- CI/CD hardening, release pipeline, and overlay EINVAL fix  (607befd)
## [0.2.11] - 2026-03-07

### Features

- ReaperPod CRD, reaper-controller, and Helm chart  (101d7ed)
## [0.2.10] - 2026-03-06
...
- Consolidate workflows and parallelize CI pipeline  (fa2f4a3)
## [0.2.8] - 2026-03-03

### Features

- **agent**: Overlay GC and mount namespace cleanup  (cac7fef)
## [0.2.7] - 2026-03-03

### Features

- Add reaper-agent per-node DaemonSet  (9fc4cc7)
- Pod annotation-based configuration overrides  (78dae3a)
- Per-namespace overlay isolation  (389a642)
- Cross-OS config file and docs cleanup  (e7c40c9)
- Add Kubernetes DNS support and unify example setup scripts  (3b4b5ff)

### Bug Fixes

- **security**: Harden runtime against critical/high vulnerabilities  (4da65e7)
- Serialize config unit tests to prevent env var race in CI  (c7ef98f)
## [0.2.6] - 2026-02-20

### Features

- Add examples 05-08 (kubemix, ansible, mixed runtimes)  (eaa34f4)
## [0.2.5] - 2026-02-20
